...
export function searchByOwnerName(name, suburbFilter) {
...
export function getOwnersForProperty(p) {
    return OWNERS.filter((o) => p.ownerIds.includes(o.ownerId));
}
export function getOverdueProperties(minDays = 1) {
    return PROPERTIES.filter((p) => p.balance > 0);
}
export function getTransactions(assessmentNumber) {
