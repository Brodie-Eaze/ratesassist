 ...
 */
export const TRANSACTIONS: Readonly<Record<string, readonly Transaction[]>> =
  Object.freeze({
    "TPS-3041-12": Object.freeze<readonly Transaction[]>([
    ...
    "ESH-7011-08": Object.freeze<readonly Transaction[]>([
    ...
    "TPS-1102-44": Object.freeze<readonly Transaction[]>([
    ...
    "ASH-9911-04": Object.freeze<readonly Transaction[]>([
    ...
    "MTI-6601-33": Object.freeze<readonly Transaction[]>([
