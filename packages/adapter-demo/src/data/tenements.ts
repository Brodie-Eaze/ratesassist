...
/**
 * Internal seed shape — flat for readability, expanded into the contract's
 * Tenement type during finalisation.
 */
type TenementSeed = {
  readonly tenementId: string;
  readonly type: TenementType;
  readonly holder: string;
  readonly holderAbn: string;
  readonly commodity: readonly string[];
  readonly areaHectares: number;
  readonly isProducing: boolean;
  readonly intersects: readonly string[];
  readonly lat: number;
  readonly lng: number;
 ...
 */
const TENEMENT_SEEDS: readonly TenementSeed[] = [
 ...
 * becomes relevant.
 */
export const TENEMENTS: readonly Tenement[] = Object.freeze(
