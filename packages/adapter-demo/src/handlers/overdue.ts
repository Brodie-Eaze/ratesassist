...
import type { Property, schemas } from "@ratesassist/contract";
 ...
 */
function daysSinceLastPayment(p: Property, now: Date): number {
...
export async function listOverdueHandler(
  input: schemas.ToolInputs["list_overdue"],
  ctx: RequestContext,
