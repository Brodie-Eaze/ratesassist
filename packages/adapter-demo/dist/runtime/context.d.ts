 ...
 * fields land.
 */
import { type AbnClient } from "@ratesassist/identity";
...
export type UserRole = "officer" | "senior_officer" | "manager" | "admin";
/**
 ...
 */
export declare const DEMO_TENANT_ID = "demo-tenant";
/**
...
export declare const DEMO_USER_ROLE: UserRole;
/**
 ...
 */
export declare function createRequestContext(args: {
    readonly store: DataStore;
    readonly commitTokens: CommitTokenStore;
    readonly abnClient: AbnClient;
    readonly tenantId?: string;
 ...
 */
export declare function createDefaultAbnClient(): AbnClient;
