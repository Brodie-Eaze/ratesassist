// In-memory data layer. Mirrors the production schema in RatesAssist.md §9.
// Expanded seed: 8 councils, 120+ properties, 25+ tenements with polygons,
// owners, transactions, integrations, activity log, bank deposits.
...
export const ACTIVITY: ActivityEvent[] = [
  ...
  { id: "A-1021", ts: "2026-05-08 09:21", user: "Mum",     council: "ESH", action: "list_overdue",            detail: "Returned 8 overdue · total $14,200", category: "lookup" },
  { id: "A-1020", ts: "2026-05-08 09:15", user: "Mum",     council: "ESH", action: "draft_chase_all_overdue", detail: "Drafted 6 friendly reminders (preview only)", category: "comms" },
  ...
  { id: "A-1014", ts: "2026-05-07 17:22", user: "Mum",     council: "ESH", action: "draft_payment_reminder",  target: "ESH-7011-08", detail: "Firm tone draft", category: "comms" },
